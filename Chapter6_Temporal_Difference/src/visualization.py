...
class AlgorithmVisualizer:
    ...
    def __init__(self, env: GridWorld):
        ...
        self.algorithm_colors = {
            'sarsa': 'green',
            'expected_sarsa': 'orange',
            'n_step_sarsa_1': 'red',
            'n_step_sarsa_2': 'darkred',
            'on_policy_qlearning': 'brown',
            'off_policy_qlearning': 'cyan'
        }
        ...
        self.algorithm_names = {
            ...
            'n_step_sarsa_1': 'N-Step SARSA_1',
            'n_step_sarsa_2': 'N-Step SARSA_2',
            'on_policy_qlearning': 'On-policy Q-Learning',
            'off_policy_qlearning': 'Off-policy Q-Learning'
        }
