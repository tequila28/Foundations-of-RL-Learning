...
from Chapter7_Value_Function_Approximation.src.experiment_one.algorithms.policy_generator import EpisodeGenerator
...
def parse_arguments():
    ...
    parser.add_argument("--n_episodes", type=int, default=500,
                       help="Number of episodes to sample for training (default: 500)")
    parser.add_argument("--learning_rate", type=float, default=0.001,
                       help="Initial learning rate for TD-Linear algorithm (default: 0.0005)")
...
def main():
    ...
    print(f"Generated {args.n_episodes} episodes, each with maximum 500 steps")
