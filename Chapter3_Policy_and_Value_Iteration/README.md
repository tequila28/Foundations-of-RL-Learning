...
| **算法配置** | | |
| **THETA** | 1e-6 | 算法停止的收敛阈值 |
| **MAX_ITERATION** | 1000 | 算法最大迭代次数，防止无限循环 |
| **TRUNCATED_INNER_ITERATION** | 5 | 截断策略迭代的默认内部迭代次数 |
| **TRUNCATED_INNER_ITERATION_LIST** | "1 5 10 20 50 100" | 截断策略迭代敏感性分析的内部迭代次数 |
